...
/** Latin-1 odczyt bajtów UTF-8 → poprawny Unicode (np. ZaÅ‚Ä…cznik → Załącznik). */
...
/**
 * Preferuj etykietę HTML gdy Content-Disposition ma mojibake,
 * w przeciwnym razie napraw CD lub użyj fallbacku.
 */
