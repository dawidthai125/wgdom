        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              {q:"Pomiary Elektryczne (EM-P1B)", a:"Roboty → wybierz robotę → sekcja „Pomiary Elektryczne”. Jedna robota może mieć wiele raportów. Po uzupełnieniu danych użyj przycisków „Generuj Protokół”, „Generuj Dane Informacyjne”, „Generuj RCD”, „Generuj ADSC” lub „Generuj Rezystancję” — pobierzesz pojedynczy plik Word (DOCX) bez ZIP. Podgląd na dole pokazuje wiersze zgodne z dokumentami. Zapis synchronizuje się w chmurze (kw-electrical-measurements)."},
