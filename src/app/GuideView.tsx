        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              {q:"Rysunki techniczne (Odbiory WM)", a:"WM Druk → „Rysunki” (zaraz po Odbiory): szybkie szkice techniczne powiązane z robotą. Włączenie: Super Admin ⚙ → Moduły → Rysunki WM (lub mirror w WM → Ustawienia). Sync chmura kw-app-settings. Szablony, ściana, drzwi (obrót + odbicie), okno, tekst / opis pomieszczenia, wymiar, strzałka, wentylacja, piec, siatka/snap, autosave, undo/redo, duplikacja zaznaczenia, obrót 90/180/270°, oznacz Final. Dane: kw-wm-technical-drawings. PDF i ZIP — w kolejnych wersjach."},
