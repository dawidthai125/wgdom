        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              {q:"Command Layer (detal przetargu)", a:"Sticky pasek u góry detalu workspace: Powrót · breadcrumb (Workspace › numer › tab; Decyzja › Kwalifikacja/Oferta) · tytuł · 5 zakładek. Następny krok (CTA workflow) na każdej zakładce w chrome. Na Przetargu dodatkowo: sygnały zaufania i pasek procesu. Kosztorys — zwarty chrome. Menu Moduł (mobile) pokazuje aktywny workspace i powrót."},
