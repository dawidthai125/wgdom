        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              {q:"Rysunki techniczne (Odbiory WM)", a:"WM Druk → „Rysunki” (zaraz po Odbiory; widoczna gdy flaga kw-wm-rysunki-01 = 1): szybkie szkice techniczne powiązane z robotą. Szablony, ściana, drzwi (obrót + odbicie), okno, tekst / opis pomieszczenia, wymiar, strzałka, wentylacja, piec, siatka/snap, autosave, undo/redo, duplikacja zaznaczenia, obrót 90/180/270°, oznacz Final. Sync: kw-wm-technical-drawings. PDF i ZIP — w kolejnych wersjach."},
