        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              {q:"Kalkulator ceny ofertowej", a:"W zakładce workspace Wycena zobaczysz od razu: koszt własny, marżę i cenę oferty (rekomendowaną). Szczegóły (breakdown, klasyfikacja, warianty) są w sekcji „Szczegóły”. Stawki robocizny i materiałów edytujesz w Przetargi → Baza cen; koszty operacyjne (załoga, poboczne) — w Profil firmy."},
              {q:"Baza cen przetargów", a:"Przetargi → Baza cen: własne stawki firmy per kategoria (robocizna rbh/j.m. i materiał zł/j.m.), region Wrocław/Dolny Śląsk, parametry rbh, Kp, marża i indeksy. Zapis do chmury (kw-wgdom-cost-catalog + profil firmy). To nie są ceny rynkowe."},
