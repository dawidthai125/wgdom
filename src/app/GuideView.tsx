        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              {q:"Command Layer (detal przetargu)", a:"Sticky pasek u góry detalu workspace: Powrót · breadcrumb (Workspace › numer › tab; Decyzja › Kwalifikacja/Oferta) · tytuł · 5 zakładek. Następny krok (CTA workflow) na każdej zakładce w chrome. Pasek procesu (5 etapów) widoczny na wszystkich zakładkach — aktywny etap podświetlony („Tu jesteś”). Chip „Podsumowanie oferty” na każdej zakładce przenosi na Przetarg do sekcji intelligence hub (bez otwierania accordionu). Chip skrótu wyceny (Kosztorys lub Wycena oferty — wg stanu kosztorysu) otwiera pierwszy tab kosztowy jednym klikiem z dowolnej zakładki. Na Przetargu dodatkowo: sygnały zaufania (zwijane) oraz wiersz „Następny krok wyceny” w hubie Podsumowanie oferty. Przy blockerach — chip „Blokery” w chrome. Kosztorys — zwarty chrome. Menu Moduł (mobile) pokazuje aktywny workspace i powrót."},
