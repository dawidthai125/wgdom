    ...
    },
    {
      ...
      content:(
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              {q:"Zakładki modułu", a:"Odbiory — lista robót pogrupowana po statusie robota (W TRAKCIE · GOTOWE DO ODBIORU · ZDANE), kompletność i generowanie ZIP. Szablony — biblioteka dokumentów (DOCX, PDF, PDF formularz) z kolejnością i włącz/wyłącz. Ustawienia — domyślne miasto (JOB_CITY) i przyrostek nazwy ZIP."},
