        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              {q:"Komunikat o zapisie pipeline po zmianie godzin", a:"Godziny zapisują się osobno do listy płac w chmurze. Komunikat „Zapis pipeline zablokowany” / reconciliation dotyczy synchronizacji przetargów — nie oznacza, że zapis godzin się nie udał. Osobny komunikat „Zapis listy płac zablokowany” to ochrona danych listy płac; konflikt zapisu to zderzenie z inną zmianą w chmurze."},
