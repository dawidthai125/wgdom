        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              {q:"Klasyfikacja przedmiaru (UNKNOWN)", a:"W szczegółach wyceny sekcja „Klasyfikacja przedmiaru” pokazuje pokrycie % pozycji ATH. Przy pozycjach UNKNOWN wybierz kategorię (MALOWANIE, GK, PODLOGI…) i Zapisz — fraza trafia do słownika użytkownika WGDOM (chmura kw-wgdom-classification-dictionary) i pokrycie rośnie bez ponownej analizy SWZ. Zarządzanie wpisami: Profil firmy → 🧠 WGDOM Classification Dictionary."},
