      ...
      content:(
        <div className="space-y-3">
          {[
            ...
            {icon:LayoutDashboard, title:"Pulpit — operacje na dziś", desc:"KPI (Wypłata, Ekipa, WM, Braki dokumentów, Pilne uwagi) → sekcja braków dokumentów → Pilne uwagi (kategorie) → skrót Przetargów. Strategia i prognozy tylko w Command Center (moduł Przetargi)."},
