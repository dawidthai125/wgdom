        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              {q:"Klasyfikacja przedmiaru (UNKNOWN)", a:"W szczegółach wyceny sekcja „Klasyfikacja przedmiaru” pokazuje pokrycie % pozycji ATH. System rozpoznaje całe frazy robocze (np. narożniki z kątownika aluminiowego), nie tylko pojedyncze słowa. Przy pozycjach UNKNOWN wybierz kategorię (MALOWANIE, GK, PODLOGI, TRANSPORT_UTYLIZACJA, WENTYLACJA…) i Zapisz — fraza trafia do słownika użytkownika WGDOM (chmura kw-wgdom-classification-dictionary) i pokrycie rośnie bez ponownej analizy SWZ. Sekcja „Top nieznane frazy” podpowiada, co warto przypisać ręcznie. Zarządzanie wpisami: Profil firmy → 🧠 WGDOM Classification Dictionary."},
