        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              {q:"Pomiary Elektryczne (WM Druk)", a:"WM Druk → „Pomiary” (edycja raportu per robota) lub „Katalog Pomiarów” (lista wszystkich RAP, filtry, ZIP archiwum). Numer RAP z rejestru chmury. Ustawienia domyślne: WM Druk → Ustawienia → Pomiary Elektryczne. 5× DOCX + ZIP pojedynczy/wielokrotny z INDEX.txt. Sync: kw-electrical-measurements + kw-electrical-measurement-registry + kw-electrical-measurement-settings."},
