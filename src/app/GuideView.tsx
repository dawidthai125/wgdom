        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              {q:"Komunikat o zapisie pipeline po zmianie godzin", a:"Zmiana godzin albo dodanie pracownika zapisuje tylko listę płac w chmurze — nie zapisuje pipeline przetargów. Komunikat „Zapis pipeline zablokowany” / reconciliation może pojawić się przy pracy z przetargami, nie przy samym zapisie godzin. Osobny komunikat „Zapis listy płac zablokowany” to ochrona danych listy płac; konflikt zapisu to zderzenie z inną zmianą w chmurze."},
