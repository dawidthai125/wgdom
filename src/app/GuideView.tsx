        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              {q:"Rysunki techniczne (Odbiory WM)", a:"WM Druk → „Rysunki” (zaraz po Odbiory): szybkie szkice techniczne powiązane z robotą. Włączenie: Super Admin ⚙ → Moduły → Rysunki WM (lub mirror w WM → Ustawienia). Sync chmura kw-app-settings. Ściana/strzałka: przeciągnij i puść (Ghost podczas gestu; Esc anuluje; po sukcesie tool Ściana zostaje; kolejna ściana od nowego pierwszego kliknięcia — nowy gest). Narzędzia: drzwi P/W, okno, wymiar (klik ściany → Długość), wentylacja, piec, rozdzielnia, tekst, siatka/snap (siatka · kąt 45° · punkty), autosave, undo/redo, duplikacja, obrót, Final. Ghost nie trafia do JSON/PDF/ZIP. Desktop: Podgląd PDF · Pobierz · Drukuj. Dane: kw-wm-technical-drawings. ZIP Odbiory: „Dołącz rysunki” gdy ≥1 Final. Szkice pracownika non-final nie są na liście Rysunki."},
              {q:"Szkice Techniczne (Dokumentacja)", a:"Roboty / Inspektor / Pracownik → Dokumentacja → „Szkice Techniczne” (≠ foto Obrys, ≠ Odbiory WM → Rysunki). Flaga: Super Admin ⚙ Moduły → Szkice pracownika (OFF). Worker: własne szkice, prześlij / prześlij ponownie po „Do poprawy”. Inspektor: wszystkie szkice roboty, edycja, „Do poprawy” (bez Accept). Admin: Accept + „Do poprawy”. Badge „oczekuje” = submitted + do poprawy. Pulpit Admin/Inspektor: sekcja Szkice Techniczne (karty robót) → Otwórz Dokumentację. Dane: kw-wm-technical-drawings (domain job_sketch). Promote do Odbiorów — w kolejnym etapie."},
