        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              {q:"Przenieś wypłatę na następny tydzień (⏭)", a:"W panelu pracownika lub na liście płac kliknij ⏭ „Przenieś na następny tydzień”. Kwota do wypłaty z bieżącego tygodnia zostaje zamrożona i trafi do następnego tygodnia płacowego — w tym tygodniu zobaczysz PRZENIESIONO zamiast kwoty. W następnym tygodniu wypłata = bieżąca + przeniesiona kwota. Działa tylko dla tygodniówki (nie dla wypłaty co 2 tygodnie). Nie można przenieść w tygodniu urlopu ani drugi raz tej samej wypłaty. Po „Zapisz tydzień” kwoty przeniesienia są zamrożone w archiwum — PDF i Word pokazują PRZENIESIONO / sumę z przeniesienia nawet po późniejszej zmianie godzin."},
