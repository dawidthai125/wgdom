        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              {q:"Klasyfikacja przedmiaru (UNKNOWN)", a:"W szczegółach wyceny sekcja „Klasyfikacja przedmiaru” pokazuje pokrycie % pozycji ATH. Przy pozycjach UNKNOWN wybierz kategorię (MALOWANIE, GK, PODLOGI, TRANSPORT_UTYLIZACJA, WENTYLACJA…) i Zapisz — fraza trafia do słownika użytkownika WGDOM (chmura kw-wgdom-classification-dictionary) i pokrycie rośnie bez ponownej analizy SWZ. Gruz i odpady mają osobną kategorię TRANSPORT_UTYLIZACJA (≠ rozbiórka). Zarządzanie wpisami: Profil firmy → 🧠 WGDOM Classification Dictionary."},
