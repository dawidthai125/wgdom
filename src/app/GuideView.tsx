        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              {q:"Baza cen przetargów", a:"Przetargi → Baza cen: globalne stawki firmy per kategoria. W Wycenie → Pozycje kosztorysowe możesz nadpisać materiał lub robociznę dla pojedynczego przetargu (Override) — bez zmiany Bazy cen. Zapis w chmurze kw-tender-price-overrides."},
