        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              {q:"Pomiary Elektryczne (WM Druk)", a:"WM Druk → zakładka „Pomiary” → wybierz robotę. Numer RAP przypisywany automatycznie (rejestr w chmurze). Domyślny pomiarowiec i miernik: WM Druk → Ustawienia → sekcja Pomiary Elektryczne (sync kw-electrical-measurement-settings) — podstawiane przy nowym raporcie; „Nadpisz dla tego raportu” zmienia tylko lokalnie. Obwody, RCD, wyniki, 5× DOCX. Zapis: kw-electrical-measurements + kw-electrical-measurement-registry + kw-electrical-measurement-settings."},
