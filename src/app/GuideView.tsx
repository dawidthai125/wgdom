        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              {q:"Workflow Hub (Przetarg)", a:"Zakładka Przetarg to centrum przygotowania oferty: na górze pasek „Proces oferty” (Dokumenty → Analiza → Kosztorys → Wycena → Oferta) — klik przenosi do zakładki V4; pod spodem sticky „Główna akcja” — jedyne miejsce rekomendowanej akcji (np. Pobierz dokumenty, Znajdź kosztorys, Policz wycenę). Niżej: postęp V2 (status, oś czasu, checklista), blokery, operator. Decyzję GO/HOLD/ODPUŚĆ zapisujesz na zakładce Decyzja."},
              ...
              {q:"Rozwiń przetarg — co się dzieje?", a:"Szczegóły przetargu mają zakładki V4: Przetarg (Workflow Hub) · Dokumenty · Kosztorys · Ceny · Decyzja · Strategia · Materiały. Auto-analiza buduje kartę z załączników BZP. W Dokumentach: Podgląd i Pobierz; gdy brak kosztorysu — szukaj u zamawiającego lub wgraj SWZ z Przetargu."},
              ...
              {q:"Jakość danych przetargowych (Trust Layer)", a:"Na Przetargu, Dokumentach, Kosztorysie i Wycenie widać banner lub chipy jakości danych (✓ wiarygodne · ! niepełne · × zablokowane · … w toku). System ocenia dokumenty, analizę załączników, kosztorys, wycenę, metadane SWZ i spójność snapshotu — bez osobnej logiki w każdej zakładce. To nie to samo co pewność rekomendacji GO/HOLD na Decyzji."},
              {q:"Główna akcja (sticky CTA)", a:"Pod paskiem procesu zawsze widać jedną główną akcję — to jedyne miejsce prezentacji rekomendowanego następnego kroku (np. Pobierz dokumenty, Przetwarzam dokumenty…, Znajdź kosztorys, Policz wycenę, Zatwierdź STARTUJ). Przycisk jest nieaktywny podczas wczytywania dokumentów. Panel V2 poniżej pokazuje wyłącznie postęp i checklistę — bez drugiego przycisku akcji. Pozostałe operacje (upload SWZ) są w sekcji operatora."},
