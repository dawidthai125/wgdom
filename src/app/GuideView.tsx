        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              {q:"Pomiary Elektryczne (WM Druk)", a:"WM Druk → zakładka „Pomiary” → wybierz robotę z listy. Numer RAP (np. RAP-45-2026) przypisywany automatycznie przy pierwszym utworzeniu raportu — trwale do roboty (rejestr w chmurze). Po usunięciu raportu ten sam numer wraca przy ponownym utworzeniu. Obwody, RCD, wyniki pomiarów, podgląd i 5 dokumentów Word (DOCX). Checklista „Pomiary” na robocie = wykonane — bez nowego numeru (administrator może utworzyć raport ponownie). Zapis: kw-electrical-measurements + kw-electrical-measurement-registry."},
