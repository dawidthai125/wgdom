        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              {q:"Rysunki techniczne (Odbiory WM)", a:"WM Druk → „Rysunki” (zaraz po Odbiory; widoczna gdy flaga kw-wm-rysunki-01 = 1): szybkie szkice techniczne powiązane z robotą. Szablony (rzut, kotłownia, …), ściana, tekst, siatka i snap, autosave, cofnij/ponów, duplikacja. Nie mylić z checklistą „rysunek” w Robotach ani z Obrysem pracownika. Sync: kw-wm-technical-drawings. PDF i ZIP — w kolejnych wersjach."},
