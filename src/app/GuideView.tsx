        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              {q:"Workflow Hub (Przetarg)", a:"Zakładka Przetarg to centrum przygotowania oferty: na górze pasek „Proces oferty” (Dokumenty → Analiza → Kosztorys → Wycena → Oferta) — klik przenosi do zakładki V4; pod spodem sticky „Główna akcja” (jedna rekomendacja, np. Pobierz dokumenty, Znajdź kosztorys, Policz wycenę). Niżej: postęp V2, blokery, operator. Decyzję GO/HOLD/ODPUŚĆ zapisujesz na zakładce Decyzja."},
              ...
              {q:"Główna akcja (sticky CTA)", a:"Pod paskiem procesu zawsze widać jedną główną akcję (np. Pobierz dokumenty, Przetwarzam dokumenty…, Znajdź kosztorys, Policz wycenę, Zatwierdź STARTUJ). Przycisk jest nieaktywny podczas wczytywania dokumentów. Pozostałe operacje (upload SWZ, checklista) są w sekcji operatora niżej."},
              {q:"Następny krok (Workflow Hub)", a:"Sekcja „Następny krok” w panelu V2 nadal pokazuje szczegóły rekomendacji; główny przycisk akcji jest w sticky „Główna akcja” pod paskiem procesu."},
