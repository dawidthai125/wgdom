        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              {q:"Pulpit — Najważniejsze dziś (20.7E)", a:"Tuż pod KPI — sekcja „Najważniejsze dziś”: cross-modułowe priorytety dnia (max 5 po rozwinięciu accordion). Domyślnie zwinięta. To nie moduł Przetargów. Szczegółowe listy i toggle dokumentów → „Uwaga dziś” poniżej (Pokaż szczegóły)."},
              {q:"Pulpit — szybki dostęp do roboty", a:"W sekcji „Uwaga dziś” (po „Pokaż szczegóły”) i „Roboty w trakcie” kliknij wiersz — aplikacja otworzy od razu tę robotę w zakładce Roboty."},
              {q:"Pulpit — Roboty do odbioru (20.5Z.5B)", a:"W „Uwaga dziś” alert „Roboty do odbioru” pokazuje roboty w fazie Do odbioru (ta sama logika co KPI w module Roboty). Widać adres, klienta i status (np. braki dokumentów lub gotowe do zdania). Klik w wiersz otwiera kartę roboty. Alert jest informacyjny — nie podwaja licznika „Braki dokumentów” w Do ogarnięcia."},
              {q:"Badge menu Roboty (20.5Z.5A)", a:"Liczba przy pozycji Roboty w menu bocznym i na dolnym pasku mobile = suma robót w fazie W toku + Do odbioru (ta sama logika co KPI po wejściu w moduł). Nie pokazuje już zdjęć oczekujących na akceptację — te są na Pulpicie w sekcji „Uwaga dziś”."},
      ...
      content:(
        <div className="space-y-3">
          {[
            ...
            {icon:LayoutDashboard, title:"Pulpit — centrum dowodzenia", desc:"KPI → „Najważniejsze dziś” (priorytety) → „Uwaga dziś” (szczegóły, accordion) → moduły. W Uwaga: zdjęcia, raporty, paragony, inspektor, spójność godzin, dokumenty. Klik w wiersz → robotę, listę płac lub Inspektora."},
