        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              {q:"Pomiary Elektryczne (WM Druk)", a:"WM Druk → zakładka „Pomiary” → wybierz robotę z listy. Tworzenie raportów, obwody, RCD, podgląd i generowanie 5 dokumentów Word (DOCX) — bez ZIP. W Robotach przy wybranej robocie widać tylko skrót (Raporty/Obwody/RCD) i przycisk „Otwórz w WM Druk”. Zapis: kw-electrical-measurements w chmurze."},
