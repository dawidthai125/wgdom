        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              {q:"Komunikaty AI (Lista)", a:"Banner pod wyszukiwarką — np. ile przetargów czeka na decyzję. Gdy są decyzje do podjęcia, klik w banner ustawia filtr „Do decyzji”. Heurystyki UX bez chmury AI."},
