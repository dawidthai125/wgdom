        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              {q:"Rysunki techniczne (Odbiory WM)", a:"WM Druk → „Rysunki” (zaraz po Odbiory): szybkie szkice techniczne powiązane z robotą. Włączenie: Super Admin ⚙ → Moduły → Rysunki WM (lub mirror w WM → Ustawienia). Sync chmura kw-app-settings. Narzędzia: ściana (podgląd Ghost + długość px/kratki podczas rysowania; po utworzeniu ściany podgląd znika — narzędzie Ściana zostaje; kolejna ściana od nowego pierwszego kliknięcia; Esc anuluje podgląd), drzwi pokojowe (P) / wejściowe (W), okno, wymiar (klik ściany → pole Długość), strzałka, wentylacja (W), piec (G), rozdzielnia (R), tekst, siatka/snap, autosave, undo/redo, duplikacja, obrót, Final. Podgląd Ghost tylko w edytorze — nie trafia do JSON/PDF/ZIP. Otwór w ścianie przy drzwiach jest tylko na rysunku (SVG/PDF/ZIP) — bez dzielenia ściany w danych. W edytorze: Podgląd PDF · Pobierz PDF · Drukuj (ten sam plik; A4/A3). Dane: kw-wm-technical-drawings. W Odbiory → Generuj ZIP: checkbox „Dołącz rysunki” (domyślnie ON gdy jest ≥1 Final) → folder Rysunki/ w paczce. Szkice robocze pracownika (non-final) nie są na liście Rysunki — dopiero po promocji Final."},
              {q:"Szkice pracownika (Dokumentacja)", a:"Panel pracownika → Dokumentacja → sekcja Szkice (≠ foto Obrys). Włączenie: Super Admin ⚙ → Moduły → Szkice pracownika (domyślnie OFF, niezależnie od Rysunki WM). Pracownik tworzy szkic (ściana/tekst), zapisuje i przesyła do weryfikacji. Ten sam silnik i magazyn co Rysunki WM (kw-wm-technical-drawings). Usuwanie tylko szkicu roboczego przed przesłaniem."},
