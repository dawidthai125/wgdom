        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              {q:"Pomiary Elektryczne (WM Druk)", a:"WM Druk → „Pomiary”: „Nowy raport” (RAP produkcyjny) lub „Nowy raport testowy” (TEST-RAP — bez registry). „Katalog Pomiarów” — lista, filtry, ZIP. Ustawienia domyślne w WM Druk → Ustawienia. Sync: kw-electrical-measurements + kw-electrical-measurement-registry."},
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              {q:"Klienci strategiczni — szybkie filtry (P3.6)", a:"Na liście Przetargów chipy: WM, ZZK, MOPS, TBS, Gminy, Uczelnie — każdy pokazuje liczbę przetargów w pipeline. Klik filtruje listę (drugi klik lub „Wyczyść klienta” wyłącza). Działa razem z wyszukiwarką i filtrem „Do zgłoszenia”. Licznik pod filtrami: „Wyświetlono X przetargów”."},
              {q:"Zarządzanie listą", a:"Menu „Więcej” na liście: Eksport CSV (aktualnie przefiltrowana lista do Excela) oraz „Zaznacz wiele” (masowy status lub usuwanie). Usuwanie pojedyncze: „Usuń z listy” w szczegółach. Usunięte przetargi nie wracają przy sync BZP. Eksport i tryb masowy zostają — są rzadko używane, ale przydatne po dużym imporcie BZP."},
