    ...
    },
    {
      ...
      content:(
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              {q:"Jak założyć nową robotę?", a:'Kliknij "Nowa robota" w lewym górnym rogu. Wpisz adres, numer mieszkania i klienta. Pod polami dat wybierz typ lokalu (Zamienny / Socjalny / Repatrianci — obowiązkowe), kuchenkę (gaz / elektr. / 2 paln.) oraz opcjonalnie piec gazowy (Zostaje / Wymiana / Brak).'},
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              {q:"Co to „Do zgłoszenia”?", a:"Domyślny filtr — tylko aktywne przetargi (otwarty termin składania ofert), z Wrocławia lub od kluczowych zamawiających, pasujące do słownika remontów wnętrz. Kliknij KPI „do zgłoszenia” lub chip na pasku szybkich filtrów."},
              {q:"Pasek szybkich filtrów (Lista)", a:"W sticky toolbarze (zostaje po scrollu): Wszystkie · Moje · Do zgłoszenia · ≤7 dni · Bez kosztorysu · WM · ZZK. Drugi klik wraca do „Do zgłoszenia”. Filtry zapisywane lokalnie w przeglądarce."},
              {q:"Moja kolejka (Lista)", a:"Workspace właściciela: Do decyzji (bez GO/HOLD/ODPUŚĆ), kończy się dziś/jutro, brak kosztorysu, brak referencji. Klik ustawia filtr i pokazuje listę — drugi klik czyści kolejkę."},
              {q:"Ulubione filtry (Lista)", a:"„Zapisz bieżące” zapisuje preset (wyszukiwarka, filtry, kolejka) w przeglądarce. Ikona pinezki przypina preset na górze. Klik nazwy stosuje preset."},
              {q:"Komunikaty AI (Lista)", a:"Krótkie podpowiedzi nad KPI — np. ile przetargów czeka na decyzję, który ma największy potencjał. To heurystyki UX (bez chmury AI), tylko podpowiedź operacyjna."},
              {q:"Workspace V2 (Przetarg)", a:"Zakładka Przetarg: pasek postępu, „Następny krok”, oś czasu, skróty dokumentów i checklista. Auto-checklista ocenia SWZ/ATH/Formularz/Referencje/Wadium (✔ ⚠ ⌛). Pod postępem — 2–3 komunikaty Insights."},
              ...
              {q:"Intelligence — werdykt STARTUJ / ANALIZUJ / ODPUŚĆ", a:"Zakładka Intelligence pokazuje werdykt po Decision Overlay (nie surowy scoring). STARTUJ = gotowe do decyzji właściciela; ANALIZUJ = brak marży lub dalsza analiza; ODPUŚĆ = twarde blokery (termin, wadium, referencje). Zakładka Strategia nadal pokazuje surowy werdykt systemu — to świadoma różnica."},
              {q:"Intelligence — jedna rekomendowana akcja", a:"Sekcja „Co robić teraz” pokazuje dokładnie jeden przycisk (np. przejdź do Wyceny, Kwalifikacji lub Zatwierdź STARTUJ). Zastępuje stare trzy równorzędne CTA „Co dalej”."},
              {q:"Executive Summary na Intelligence vs w modalu PDF", a:"Na zakładce Intelligence widzisz skrót głównych robót z snapshotu dossier (bez otwierania PDF). W modalu podglądu dokumentu Executive Summary może dodatkowo wnioskować roboty z tekstu PDF (P2A) — na panelu Intelligence ta inferencja z tekstu PDF nie działa; to znane ograniczenie Sprint 1."},
              {q:"Zakładka Dokumenty — najważniejsze pliki", a:"W workspace Dokumenty na górze listy widać do 5 najważniejszych załączników (SWZ, ATH/przedmiar, formularz ofertowy itd.). Nazwy plików są czytelniejsze (polskie znaki, spacje zamiast podkreśleń) — oryginalna nazwa pliku przy pobieraniu się nie zmienia. Gdy jest więcej dokumentów, reszta jest zwinięta pod „Pokaż pozostałe dokumenty (X)”."},
              ...
              {q:"Strategia przetargów — co mam zrobić dziś?", a:"Zakładka Strategia zaczyna się od 4 liczników (decyzje, terminy ≤7 dni, monitoring, wygrane bez roboty), potem: Wymaga decyzji dziś, Termin pilny, jeden feed Monitoring (zmiany + Q&A + dokumenty + terminy — bez duplikatów), Najlepsza okazja w skrócie. Sekcje analityczne (kondycja, finanse, prognoza, co-jeśli, portfel) są domyślnie zwinięte — Rozwiń po szczegóły."},
              ...
              {q:"Kosztorys PRO — ekran decyzyjny", a:"W workspace Kosztorys (V4.2) na górze panel KOSZTORYS PRO: 8 KPI (pozycje ATH, wycenione/niewycenione, pokrycie %, wartość wyceny, średnia marża, FIT WGDOM, status GOTOWE DO OFERTY / WYMAGA WYCENY). Niżej TOP 20 największych pozycji kosztowych, filtry branżowe (Wykończeniowe, Sanitarne, Elektryczne, Dachowe, Drogowe) i karta „Ocena kosztorysu” z rekomendacją. Pełna tabela ATH zostaje pod spodem. „Pełny podgląd ATH” otwiera modal; „Pobierz ATH” zapisuje oryginalny plik źródłowy, gdy jest w dossier."},
              ...
              {q:"Baza cen przetargów", a:"Przetargi → Baza cen: globalne stawki firmy per kategoria. Kolumna Benchmark pokazuje orientacyjny zakres robocizny (MVP statyczny) — tylko podgląd, bez zmiany wyceny. Override per przetarg ustawiasz w Wycenie → Pozycje kosztorysowe."},
              ...
              {q:"Zarządzanie listą", a:"Ikony na pasku pod filtrami: zaznacz wiele (masowy status/usuwanie), eksport CSV (przefiltrowana lista). Usuwanie pojedyncze: „Usuń z listy” w szczegółach. Zaawansowane filtry listy i statusu: przycisk „Filtry zaawansowane”."},
