        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              {q:"Command Layer (detal przetargu)", a:"Sticky pasek u góry detalu: Powrót · tytuł · 5 zakładek (Przetarg · Dokumenty · Kosztorys · Ceny · Decyzja). Na Przetargu dodatkowo Status Ribbon i Główna akcja — mieszczą się w limicie wysokości (desktop ≤280 px, mobile ≤50vh). Kosztorys ma zwarty chrome (tylko powrót, tytuł, taby). Na tablecie i mobile detal jest pełnoekranowy (bez nagłówka modułu Przetargi)."},
              ...
              {q:"Główna akcja (sticky CTA)", a:"Jedyna rekomendowana akcja na Przetargu — w Command Layer (nie w treści). Przycisk min. 44 px na mobile. Nieaktywny podczas wczytywania dokumentów. Szczegóły postępu i checklista są w accordionie — bez drugiego CTA."},
