        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              {q:"Pomiary Elektryczne (EM-P0)", a:"Roboty → wybierz robotę → sekcja „Pomiary Elektryczne”. Jedna robota może mieć wiele raportów (np. RAP-12-2026, pomiar po poprawkach). Wpisz numer, datę, pomiarowca, model i numer miernika, wybierz zasilanie YDY, dodaj obwody (typ + wyłącznik B/C) i RCD (symbol + P302/P304). Podgląd na dole pokazuje liczbę dokumentów (5), obwodów i RCD oraz wiersze pod przyszłe protokoły DOCX (EM-P1). Zapis synchronizuje się w chmurze (kw-electrical-measurements)."},
