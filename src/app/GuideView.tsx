        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              {q:"Klasyfikacja przedmiaru (UNKNOWN)", a:"W szczegółach wyceny sekcja „Klasyfikacja przedmiaru” pokazuje pokrycie % pozycji ATH. System rozpoznaje całe frazy robocze (np. narożniki z kątownika aluminiowego → GLADZIE_TYNKI, tabliczki opisowe → WYPOSAZENIE). GK dotyczy tylko zabudowy suchej (płyty, profile CD). Przy pozycjach UNKNOWN wybierz kategorię i Zapisz — fraza trafia do słownika użytkownika WGDOM (chmura kw-wgdom-classification-dictionary). Sekcja „Top nieznane frazy” podpowiada, co warto przypisać ręcznie. Zarządzanie: Profil firmy → 🧠 WGDOM Classification Dictionary."},
