        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              {q:"Workflow Hub (Przetarg)", a:"Zakładka Przetarg to centrum przygotowania oferty: postęp V2, „Następny krok”, blokery, status kosztorysu/wyceny, plik pozycji, operator (analiza, bid prep, upload). Oś czasu, skróty dokumentów i checklista. Auto-checklista: SWZ/ATH/Formularz/Referencje/Wadium (✔ ⚠ ⌛)."},
              ...
              {q:"Następny krok (Workflow Hub)", a:"Na Przetargu sekcja „Następny krok” (V2) pokazuje jedną rekomendowaną akcję (np. przejdź do Dokumentów lub Wyceny). Decyzję GO/HOLD/ODPUŚĆ zapisujesz na zakładce Decyzja."},
