        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              {q:"Dokumenty do odbioru — co to jest?", a:"To lista dokumentów które trzeba zebrać żeby zdać robotę. Zaznaczaj je gdy je masz: Zlecenie, Zakres robót, Kosztorys, Kominiarz, Pomiary, Oświadczenia, Gwarancje, Rysunek/Plan. Zdjęcia są opcjonalne. Pozycja „Rysunek/Plan” spełnia się m.in. uploadem planu technicznego PDF (admin, Pliki roboty) albo szkicem/wymiarami z raportu ekipy. Pasek postępu na liście robót pokazuje ile dokumentów masz już skompletowanych."},
              ...
              {q:"Szkic terenowy vs plan techniczny PDF (20.5A.9)", a:"To dwa różne artefakty. Szkic terenowy — zdjęcie lub odręczny rzut z budowy (JPG/PNG) — wrzuca ekipa lub inspektor w raporcie z wymiarami; trafia do Zdjęć. Plan techniczny — gotowy PDF z biura (legendy, wymiary, opisy) — wgrywa administrator w Robotach → Pliki roboty → „Dodaj plan techniczny”. Upload planu technicznego PDF automatycznie zaznacza wymagany dokument odbiorowy „Rysunek/Plan” (ta sama pozycja checklisty co szkic/wymiary). Nie wrzucaj planu PDF jako Zlecenie."},
