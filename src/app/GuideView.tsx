        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              {q:"Command Layer (detal przetargu)", a:"Sticky pasek u góry detalu: Powrót · kontekst mobile (jedna linia) · tytuł · 5 zakładek (Przetarg · Dokumenty · Kosztorys · Ceny · Decyzja). Na Przetargu: zwijane sygnały zaufania, zawsze widoczny pasek procesu i Główna akcja — przy wyłączonym CTA widać powód (np. trwa analiza). Kosztorys ma zwarty chrome (tylko powrót, tytuł, taby). Na tablecie i mobile detal jest pełnoekranowy (bez nagłówka modułu Przetargi)."},
              ...
              {q:"Główna akcja (sticky CTA)", a:"Jedyna rekomendowana akcja na Przetargu — w Command Layer (nie w treści). Przycisk min. 44 px na mobile. Gdy jest nieaktywny, pod przyciskiem widać powód (np. trwa przetwarzanie dokumentów). Szczegóły postępu i checklista są w accordionie — bez drugiego CTA."},
