        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              {q:"Pulpit — karta Do odzyskania", a:"Na Pulpicie (pod skrótami liczbowymi) karta z 4 KPI: łączna kwota do odzyskania, liczba pozycji, ile częściowo rozliczonych, suma odzyskana. Pod spodem skrót aging (0–30 / 31–60 / 61–90 / 90+ dni) — sumy PLN nierozliczonych pozycji. Widać wiek najstarszej pozycji. Klik → moduł Do rozliczenia. Obramowanie ostrzegawcze gdy pozycja > 30 dni lub kwota ≥ 2 000 PLN."},
