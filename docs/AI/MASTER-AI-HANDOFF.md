...
> **★★ IK-IDENTITY-APPLY-MOPS-ELEC-RC1 (2026-09-22):** **EPIC CLOSED** · source **`b64a5d8a`** · MOPS 6/6 CONNECT identity + positionComplete · **≠** Full Autonomy · **≠** MOPS full tender · [`CLOSEOUT`](../architecture/IK-IDENTITY-APPLY-MOPS-ELEC-RC1-CLOSEOUT.md)
> **★★ IK-IDENTITY-KLAMKI-CLOUD-PERSISTENCE-LOSS (2026-09-24):** **CLOSED / PRODUCTION VERIFIED** · UI **2.66.235** · commit **`643bd6e0`** · gated persist C latch + D cloud readback + lost-update + live guard · **≠** Full Autonomy · **≠** Rate/Catalog · [`CLOSEOUT`](../architecture/IK-IDENTITY-KLAMKI-CLOUD-PERSISTENCE-LOSS-CLOSEOUT.md)
...
**STORAGE-TIER1 (pipeline local):** **EPIC CLOSED** @ HISTORY epic tip **2.66.231 / `16bfb9f3`** (CURRENT LIVE **`643bd6e`** · HISTORY Decision C **`50bce20`** · HISTORY mid-chain Tender Freeze **`cc210d9`**) — IDB FULL → LS INDEX → Cloud LEAN · [`EPIC-CLOSEOUT`](../architecture/STORAGE-TIER1-PIPELINE-CONTRACT-01-EPIC-CLOSEOUT.md) · **NIE** reopen Track B · **NIE** downgrade · **NIE** traktuj INDEX jako FULL.

**FORM-FIELD-A11Y-01 (2026-09-20):** **CLOSED / PRODUCTION VERIFIED · GREEN** · **`110aec71`** / **HISTORY live-at-PV** **`110aec7`** (CURRENT LIVE **`643bd6e`** · HISTORY Decision C **`50bce20`** · HISTORY mid-chain **`cc210d9`**) · UI **2.66.231 bez bumpu** · OV FAIL→Delta→PASS · prod smoke S1–S5 = **0** · CORS/BIP/409/500 = nie regresja A11Y · [`CLOSEOUT`](../architecture/FORM-FIELD-A11Y-01-CLOSEOUT.md) · **NIE** reopen · **NIE** Payroll/IK/Storage/WRITE_AUDIT.
...
| **LIVE tip (CURRENT)** | **FETCH** `/version.json` · expected **2.66.235 / `643bd6e`** · SOURCE OF TRUTH [`09`](09_PRODUCTION_BASELINE.md) |
...
| **STORAGE-TIER1 pipeline** | **EPIC CLOSED / PRODUCTION VERIFIED** @ HISTORY epic tip **2.66.231 / `16bfb9f3`** (CURRENT LIVE **`643bd6e`** · HISTORY Decision C **`50bce20`** · HISTORY mid-chain Tender Freeze **`cc210d9`**) — IDB FULL → LS INDEX → Cloud LEAN · flag ON · min 2.66.231 · downgrade **UNSUPPORTED** · [`EPIC-CLOSEOUT`](../architecture/STORAGE-TIER1-PIPELINE-CONTRACT-01-EPIC-CLOSEOUT.md) · Track B Cloud LEAN **UNCHANGED** |
...
| **PRZETARGI_CLEANUP-01 WAVE 4** | **CLOSED** @ **`3de1262a`** · UI 2.66.231 bez bumpu · orphan qualification section removed · hub conditional on `scoringContext` · [`WAVE-4-CLOSEOUT`](../architecture/PRZETARGI-CLEANUP-01-WAVE-4-CLOSEOUT.md) |
