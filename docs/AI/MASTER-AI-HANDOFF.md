...
> **★★ CURRENT PRODUCTION:** **2.66.165 / `75d0f09`** · **TPI FULL SNAPSHOT HYDRATION DESIGN-C CLOSED/PV** · LINE-TOLERANT HISTORY · OD-OCR-47 **HISTORY** · **TPI Full IK E2E OPEN / NOT VERIFIED** · **GLOBAL IK PRODUCTION VERIFIED = NO**
...
ACTIVE IMPLEMENT = NONE bez Owner GO · production tip 2.66.165 / 75d0f09 · GLOBAL IK PV = NO
```
...
W&G DOM jest w trybie **UTRZYMANIE**. Tip: czytaj [`09`](09_PRODUCTION_BASELINE.md) + live `version.json` — **CURRENT 2.66.165 / `75d0f09`**. **CURRENT CASE = ŚRODA A0.2** (frontend PV **VERIFIED**). **TPI FULL SNAPSHOT HYDRATION DESIGN-C CLOSED/PV** (Master §10.0.2 · ≠ TPI Full IK E2E · ≠ Global IK PV). **LINE-TOLERANT** = HISTORY feature tip **`a5d19047`**. **OD-OCR-47 PASS** = HISTORY capability tip. **TPI Full IK E2E = OPEN / NOT VERIFIED**. **CHROBREGO CLOSED**. **Track B CLOSED / VERIFIED**. **AUTONOMY-08 epic NOT CLOSED**. Experience Phase **5 NOT AUTHORIZED**. **GLOBAL IK PRODUCTION VERIFIED = NO**.
...
| **CURRENT LIVE / REPOSITORY TIP** | **`75d0f09`** / **2.66.165** · SOURCE OF TRUTH [`09`](09_PRODUCTION_BASELINE.md) · TPI HYDRATION DESIGN-C CLOSED/PV · LINE-TOLERANT HISTORY · OD-OCR-47 HISTORY · TPI Full IK E2E OPEN / NOT VERIFIED |
