...
6. **MARKET-SYNC-01 P1 CLOSED** (2.65.85 · `5326cf8c`) — Accept+Publish via **tylko** `commitMarketQuotesImport`; Kill Switch default OFF; P2 = AUDIT+Owner GO. P0 Preview staging pozostaje.
