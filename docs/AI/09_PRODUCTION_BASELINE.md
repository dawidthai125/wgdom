...
| **Deploy tip commit (`main` / `version.json`)** | **Feature tip:** **`61b7590`** (COST-S3) · docs tip = last push after PV finalize |
...
| **Status** | **PRODUCTION VERIFIED · GREEN** · COST-S3 **PV** `version.json` = **2.65.54** / **`61b7590`** |
