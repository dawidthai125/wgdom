...
| **UI version (changelog / version.json)** | **2.65.69** (COSTORYS-UX-01 WAVE 1) · **DEPLOY PROPAGATING** (live 2.65.68) |
| **Deploy tip commit (`main` / `version.json`)** | Feature **`3e57e8d`** · live VERIFY **`765668d`** / **2.65.68** · prior CATALOG-BID-01 **`e10efa9`** |
