...
| **Deploy tip commit (`main` / `version.json`)** | **Feature tip:** **`b321867`** (COST-S4) · docs tip = last push after PV finalize |
...
| **Status** | **PRODUCTION VERIFIED · GREEN** · COST-S4 **PV** `version.json` = **2.65.55** / **`b321867`** |
