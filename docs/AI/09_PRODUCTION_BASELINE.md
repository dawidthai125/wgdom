...
**Snapshot dokumentacji:** 2026-07-30 (**CATALOG-COVERAGE-01 P0a CLOSED**) · tip UI **2.65.87** · feature **`51a56f0d`** · **PRODUCTION VERIFIED**.
...
| **UI version (changelog / version.json)** | **2.65.87** |
| **Deploy tip commit (`main` / `version.json`)** | feature **`51a56f0d`** · docs tip **`512e6a46`** · **PRODUCTION VERIFIED** · [`P0a-CLOSEOUT`](../architecture/CATALOG-COVERAGE-01-P0a-CLOSEOUT.md) · [`RELEASE`](../architecture/CATALOG-COVERAGE-01-P0a-RELEASE-REPORT.md) |
