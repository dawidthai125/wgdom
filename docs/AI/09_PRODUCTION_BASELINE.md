...
| **Deploy tip commit (`main` / `version.json`)** | **Feature tip:** **`7c04203`** (AP2-S2) · docs tip = last push after PV finalize |
...
| **Status** | **PRODUCTION VERIFIED · GREEN** · AP2-S2 **PV** `version.json` = **2.65.49** / **`7c04203`** |
