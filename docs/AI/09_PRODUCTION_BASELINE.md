...
**Snapshot dokumentacji:** 2026-07-28 (**COSTORYS-UX-01 WAVE 1**) · feature UI **2.65.69** · tip commit w §1 · prior CATALOG-BID-01 **2.65.68**.
...
| **UI version (changelog / version.json)** | **2.65.69** (COSTORYS-UX-01 WAVE 1) |
| **Deploy tip commit (`main` / `version.json`)** | Feature tip po push — prior CATALOG-BID-01 **`e10efa9`** / **2.65.68** |
...
| **Ostatni feature (COSTORYS-UX-01 W1)** | Sticky oferta · full width · accordion · Evidence collapsed · filtr review — [`DF`](../architecture/COSTORYS-UX-01-WAVE-1-DESIGN-FREEZE.md) · [`CLOSEOUT`](../architecture/COSTORYS-UX-01-WAVE-1-CLOSEOUT.md) · UI **2.65.69** |
