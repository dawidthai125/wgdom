...
| **UI version (changelog / version.json)** | **2.65.71** (COST-REGRESSION-01 EPIC A) · **PRODUCTION VERIFIED** |
| **Deploy tip commit (`main` / `version.json`)** | Feature **`0a96744`** · tip docs / live **`05b5aac`** · prior WAVE 2 **`ef122a5`** |
