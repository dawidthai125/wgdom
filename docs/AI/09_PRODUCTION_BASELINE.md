...
| **Deploy tip commit (`main` / `version.json`)** | **Feature tip:** **`3e23631`** (AP2-S3) · docs tip = last push after PV finalize |
...
| **Status** | **PRODUCTION VERIFIED · GREEN** · AP2-S3 **PV** `version.json` = **2.65.50** / **`3e23631`** |
