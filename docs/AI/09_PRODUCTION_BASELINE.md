...
| **UI version (changelog / version.json)** | **2.65.68** (CATALOG-BID-01) · **DEPLOY PROPAGATING** (live 2.65.67) |
| **Deploy tip commit (`main` / `version.json`)** | Feature **`e10efa9`** · live VERIFY **`36fdda5`** / **2.65.67** · prior BUGFIX-01 **`fdfdc05`** |
