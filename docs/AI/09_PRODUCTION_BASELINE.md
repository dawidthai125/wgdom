...
| **Deploy tip commit (`main` / `version.json`)** | **Feature tip:** **`fd4b112`** (COST-S1) · docs tip = last push after PV finalize |
...
| **Status** | **PRODUCTION VERIFIED · GREEN** · COST-S1 **PV** `version.json` = **2.65.52** / **`fd4b112`** |
