...
> **★ Główny handoff projektu (SSOT)** · **Data closeout:** 2026-07-11 (**prod target 2.63.96** @ **`f6f7265`** · verify **DEPLOY PROPAGATING** · **WIP:** TWSL **2.63.91** · **STABILIZATION WINDOW ACTIVE**)
...
|------|--------|--------|------|
| **NG11-Q3** — Debounced Persist | **2.63.96** (`f6f7265`) | **RELEASED** · OWNER QA **PASS** · test **91/91** · verify `version.json` **PENDING** | [`architecture/NG11-Q3-CLOSEOUT.md`](architecture/NG11-Q3-CLOSEOUT.md) · [`architecture/NG11-Q3-RELEASE-VERIFICATION.md`](architecture/NG11-Q3-RELEASE-VERIFICATION.md) |
