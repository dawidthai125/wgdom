...
> **Data closeout:** 2026-08-12 (**EQUIPMENT-01 CONTRACT-ONLY CLOSED** · tip UI **2.66.43** / **`8e4f394`** → [`AI/09_PRODUCTION_BASELINE.md`](AI/09_PRODUCTION_BASELINE.md)) · **PRODUCTION VERIFIED · GREEN** · Equipment GAP/F5 FAIL · pricing **NOT IMPLEMENTED** · prior C-MODE-1a / F0–F6 / CLOUD-SYNC recovery **CLOSED** · **STABILIZATION WINDOW ACTIVE** · SSOT [`architecture/EQUIPMENT-01-CLOSEOUT.md`](architecture/EQUIPMENT-01-CLOSEOUT.md) · [`architecture/EQUIPMENT-01-PRODUCTION-VERIFY.md`](architecture/EQUIPMENT-01-PRODUCTION-VERIFY.md) · cold-start [`AI/WGDOM-COLD-START-HANDOFF.md`](AI/WGDOM-COLD-START-HANDOFF.md)
