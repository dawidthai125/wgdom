...
> **Status:** **CLOSED** · **Prod baseline:** v**2.50.58** · commit **`211364b`** · deploy **`4999362359`**
...
|--------|--------|--------|--------|--------|
| **20.5A.12** Files Hub | 2.50.58 | `211364b` | `4999362359` | [`RELEASE-REPORT-20.5A.12.md`](RELEASE-REPORT-20.5A.12.md) |
