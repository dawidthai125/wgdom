...
> **★★ Tip produkcji (SSOT):** [`AI/09_PRODUCTION_BASELINE.md`](AI/09_PRODUCTION_BASELINE.md) — APP **2.66.165** · DEPLOYED tip **`14ec9bd9`** · HYDRATION VERIFY **`75d0f09`** · **TPI FULL SNAPSHOT HYDRATION DESIGN-C CLOSED/PV** · LINE-TOLERANT HISTORY · OD-OCR-47 HISTORY · **TPI Full IK E2E OPEN / NOT VERIFIED** · live `version.json` · **nie** traktuj numerów w bannerach poniżej jako tip (historyczne closeouty).
...
| **Commit** | **`590f95e9`** (A0.2 seed) · live tip **`14ec9bd9` / 2.66.165** · HYDRATION VERIFY **`75d0f09`** · LINE-TOLERANT HISTORY **`a5d19047`** · OD-OCR-47 HISTORY **`2f3d1847` / 2.66.147** |
...
| **Capability** | **TPI HYDRATION DESIGN-C CLOSED/PV** @ VERIFY **`75d0f09`** · **≠** DEPLOYED tip **`14ec9bd9`** · **TPI Full IK E2E OPEN / NOT VERIFIED** · **OD-OCR-47 PASS** HISTORY · **≠** nowy Decision Tree · **GLOBAL IK PV = NO** |
