...
> **★★ Tip produkcji (SSOT):** [`AI/09_PRODUCTION_BASELINE.md`](AI/09_PRODUCTION_BASELINE.md) — APP **2.66.235** · LIVE = **FETCH** `/version.json` · expected **`643bd6e`** · LAST VERIFIED SOURCE **`16bfb9f3`** · **STORAGE-TIER1 EPIC CLOSED** · HYDRATION VERIFY **`75d0f09`** · **TPI FULL SNAPSHOT HYDRATION DESIGN-C CLOSED/PV** · LINE-TOLERANT HISTORY · OD-OCR-47 HISTORY · **TPI Full IK E2E OPEN / NOT VERIFIED** · **no** SSOT≡live equality · **nie** traktuj numerów w bannerach poniżej jako tip (historyczne closeouty).
> **★★ STORAGE-TIER1-PIPELINE-CONTRACT-01:** **CLOSED / PRODUCTION VERIFIED** · IDB FULL → LS INDEX → Cloud LEAN · flag `true` · min `2.66.231` · downgrade **UNSUPPORTED** · [`architecture/STORAGE-TIER1-PIPELINE-CONTRACT-01-EPIC-CLOSEOUT.md`](architecture/STORAGE-TIER1-PIPELINE-CONTRACT-01-EPIC-CLOSEOUT.md)
> **★★ FORM-FIELD-A11Y-01 (2026-09-20):** **CLOSED / PRODUCTION VERIFIED · GREEN** · **`110aec71`** / live **`110aec7`** · UI **2.66.231 bez bumpu** · S1–S5 = **0** · CORS/BIP ≠ A11Y · [`architecture/FORM-FIELD-A11Y-01-CLOSEOUT.md`](architecture/FORM-FIELD-A11Y-01-CLOSEOUT.md) · **NIE** reopen · **NIE** Payroll/IK/Storage
> **★★ PRZETARGI_CLEANUP-01 WAVE 4 (2026-09-20):** **CLOSED / PRODUCTION VERIFIED** · source **`3de1262a`** · UI **2.66.231 bez bumpu** · [`architecture/PRZETARGI-CLEANUP-01-WAVE-4-CLOSEOUT.md`](architecture/PRZETARGI-CLEANUP-01-WAVE-4-CLOSEOUT.md) · **NIE** przywracać `TenderQualificationSection` · hub **CONDITIONAL** na `scoringContext`
> **★★ IK Master SSOT:** [`architecture/INTELLIGENT-ESTIMATOR-MASTER-SSOT.md`](architecture/INTELLIGENT-ESTIMATOR-MASTER-SSOT.md) — **CURRENT NODE = ŚRODA A0.2** · frontend PV **VERIFIED** · **hydration §10.0.2** · **LINE-TOLERANT §2A.9 HISTORY** · **CHROBREGO CLOSED** · **GLOBAL IK PV = NO** · **Track B CLOSED / VERIFIED** · **STORAGE-TIER1 §10.5.1 CLOSED**
> **★★ IK-IDENTITY-APPLY-MOPS-ELEC-RC1 (2026-09-22):** **EPIC CLOSED** · seam **`b64a5d8a`** · MOPS 6 CONNECT lines identity+cost closed · **≠** Full Autonomy · [`architecture/IK-IDENTITY-APPLY-MOPS-ELEC-RC1-CLOSEOUT.md`](architecture/IK-IDENTITY-APPLY-MOPS-ELEC-RC1-CLOSEOUT.md)
> **★★ IK-IDENTITY-KLAMKI-CLOUD-PERSISTENCE-LOSS (2026-09-24):** **CLOSED / PRODUCTION VERIFIED** · **Last CLOSED** · Application **2.66.235 / `643bd6e0`** · Documentation **`f756b27b`** (DOCUMENTATION-ONLY) · C flush latch + D cloud readback + lost-update + live guard · **≠** Full Autonomy · **≠** Rate/Catalog · [`architecture/IK-IDENTITY-KLAMKI-CLOUD-PERSISTENCE-LOSS-CLOSEOUT.md`](architecture/IK-IDENTITY-KLAMKI-CLOUD-PERSISTENCE-LOSS-CLOSEOUT.md)
> **★★ CHAT MEMORY != SSOT:** nowy agent czyta canonical docs (Master §1.4 · AI Continuity · 09 · closeout) **przed** działaniem — historia czatu **nie** zastępuje SSOT.
...
| **Commit** | **`590f95e9`** (A0.2 seed) · LAST VERIFIED SOURCE **`32a90fef` / 2.66.165** · LIVE = fetch `/version.json` · HYDRATION VERIFY **`75d0f09`** · LINE-TOLERANT HISTORY **`a5d19047`** · OD-OCR-47 HISTORY **`2f3d1847` / 2.66.147** |
...
| **SSOT** | Master [`INTELLIGENT-ESTIMATOR-MASTER-SSOT.md`](architecture/INTELLIGENT-ESTIMATOR-MASTER-SSOT.md) §10.0 · §10.0.2 · §22 · §24 |
| **CHROBREGO** | **CLOSED** 56/0 · **NIE reopen** |
| **Capability** | **TPI HYDRATION DESIGN-C CLOSED/PV** @ VERIFY **`75d0f09`** · **≠** LAST VERIFIED SOURCE **`32a90fef`** · **≠** LIVE · **TPI Full IK E2E OPEN / NOT VERIFIED** · **OD-OCR-47 PASS** HISTORY · **≠** nowy Decision Tree · **GLOBAL IK PV = NO** |
