...
> **★★ Tip produkcji (SSOT):** [`AI/09_PRODUCTION_BASELINE.md`](AI/09_PRODUCTION_BASELINE.md) — APP **2.66.165** · LIVE = **FETCH** `/version.json` · LAST VERIFIED SOURCE **`32a90fef`** · HYDRATION VERIFY **`75d0f09`** · **TPI FULL SNAPSHOT HYDRATION DESIGN-C CLOSED/PV** · LINE-TOLERANT HISTORY · OD-OCR-47 HISTORY · **TPI Full IK E2E OPEN / NOT VERIFIED** · **no** SSOT≡live equality · **nie** traktuj numerów w bannerach poniżej jako tip (historyczne closeouty).
> **★★ IK Master SSOT:** [`architecture/INTELLIGENT-ESTIMATOR-MASTER-SSOT.md`](architecture/INTELLIGENT-ESTIMATOR-MASTER-SSOT.md) — **CURRENT NODE = ŚRODA A0.2** · frontend PV **VERIFIED** · **hydration §10.0.2** · **LINE-TOLERANT §2A.9 HISTORY** · **CHROBREGO CLOSED** · **GLOBAL IK PV = NO** · **Track B CLOSED / VERIFIED**
