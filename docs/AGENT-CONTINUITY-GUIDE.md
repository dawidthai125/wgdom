...
> **★★ Tip produkcji (SSOT):** [`AI/09_PRODUCTION_BASELINE.md`](AI/09_PRODUCTION_BASELINE.md) — CURRENT **2.66.165 / `75d0f09`** · **TPI FULL SNAPSHOT HYDRATION DESIGN-C CLOSED/PV** · LINE-TOLERANT HISTORY · OD-OCR-47 HISTORY · **TPI Full IK E2E OPEN / NOT VERIFIED** · live `version.json` · **nie** traktuj numerów w bannerach poniżej jako tip (historyczne closeouty).
...
| **Commit** | **`590f95e9`** (A0.2 seed) · live tip **`75d0f09` / 2.66.165** · LINE-TOLERANT HISTORY **`a5d19047`** · OD-OCR-47 HISTORY **`2f3d1847` / 2.66.147** |
...
| **Capability** | **TPI HYDRATION DESIGN-C CLOSED/PV** @ **`75d0f09`** · **TPI Full IK E2E OPEN / NOT VERIFIED** · **OD-OCR-47 PASS** HISTORY · **≠** nowy Decision Tree · **GLOBAL IK PV = NO** |
