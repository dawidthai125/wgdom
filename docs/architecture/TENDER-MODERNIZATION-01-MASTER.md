...
| **DEPENDENCIES** | S5 |
| **LOCKS** | ZERO third store · NO cloud in TM-01 · mapping approve→GO / reject→NO-GO / needs_review→HOLD |
| **ROLLBACK** | bridge OFF → independent stores |
| **NEXT** | S7 |
...
|--|--|
| **STATUS** | **OPEN** |
| **CEL** | TRE-01 Outcome ≠ primary landing · Hub-first Expert |
| **CO ZROBIONO** | — |
