...
3. docs/PROJECT-HANDOFF-CURRENT.md  ← ★★ SSOT baseline prod (2.65.9)
...
| Wersja UI | `CHANGELOG[0].version` w `changelog-data.ts` (**2.65.9**) |
| Prod `main` (app) | **v2.65.9** (`f8a64d7`) · **JOBS-ASSETS-SYNC-01 RELEASE GO** · Protected Core **GREEN** |
