...
3. docs/PROJECT-HANDOFF-CURRENT.md  ← ★★ SSOT baseline prod (2.65.8)
...
| Wersja UI | `CHANGELOG[0].version` w `changelog-data.ts` (**2.65.8**) |
| Prod `main` (app) | **v2.65.8** (`8b3c991`) · **NG11-FF-01 CLOSED** · Protected Core **GREEN** |
