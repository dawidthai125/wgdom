...
| **5** | **Bundle #5A — Work Catalog P2 test manifest sync** | docs + test manifest | **CLOSED** (commit pending push) · runtime frozen `5d2b207` · `smoke-work-catalog-p2-mvp` |
| 6 | Work Catalog P2.7+ (pakiety UI) | FEATURE | OPEN · owner brief |
