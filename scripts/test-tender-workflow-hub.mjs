...
assert(!v2Panel.includes("Następny krok"), "V2: no duplicate next-action section");
...
console.log("\n3. Decyzja — decision-only view");
const decision = readSrc("src/app/TenderDecisionView.tsx");
const owner = readSrc("src/app/TenderOwnerView.tsx");
...
assert(owner.includes("TenderDecisionView"), "OwnerView delegates to DecisionView");
...
assert(!panel.includes("TenderOwnerView"), "panel: no full OwnerView");
