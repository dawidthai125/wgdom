/**
 * W&G DOM — Przetargi Strategia — test Financial capacity (Przetargi Strategia) ETAP 6E
...
const { computeForecast90Days, collectGoCandidates } = await import("../src/lib/tenders-strategy-forecast-90d.ts");
...
const { computeFinancialCapacity } = await import("../src/lib/tenders-strategy-financial-capacity.ts");
