...
console.log("\n2. Decision / Hub copy SSOT (EPIC A — TenderDecisionView)");
...
assert(decisionView.includes("intelligenceCtx"), "Decision view receives intelligenceCtx");
assert(!decisionView.includes("scoreTenderForOwnerView"), "no scoring in DecisionView");
assert(!decisionView.includes("OwnerNextSteps"), "OwnerNextSteps absent from DecisionView");
